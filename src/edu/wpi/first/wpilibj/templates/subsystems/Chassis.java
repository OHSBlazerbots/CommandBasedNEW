...
public class Chassis extends Subsystem {
     ...
     */
    public Chassis(int frontLeftMotor, int rearLeftMotor,
    ...
    /**
     * Command the chassis to drive with the Kinect.
     * Raising the right arm moves the chassis forward. Lowering the right arm
     * does nothing.
     * The left arm is used to control rotation(turning). Raising the left arm
     * turns right and lowering it turns left.
     *
     * @param leftArm
     * @param rightArm
     */
